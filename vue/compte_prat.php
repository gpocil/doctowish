<!DOCTYPE html>
<link rel="stylesheet" href="../assets/css/compte_prat.css">
...
<?php
    ...
    <li><b>Mail :</b> <?=$mail?></li>
	<li><a href="?action=compte_prat&p=update">Modifier mes coordonnées</a></li>
    <li><a href="?action=compte_prat&p=pw">Modifier mon mot de passe</a></li>
